...
date: 2024-02-02 # Date (YYYY-MM-DD) you completed this project, if omitted the Site Params noDatePlaceholder will be displayed instead
image: "image.jpg" # Cover image (displayed in list and single views), stored in this director
skills: # Project skills (displayed in list and single views)
  - c++
  - python
tags: # Project tags (displayed in list and single views)
  - Embedded
  - Software

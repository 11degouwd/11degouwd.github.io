...
draft: false
---
The Atmos Mk1 project began with me designing the initial electrical and system architecture and later evolved into more of a lead systems architect role as the project and team expanded. Using a top-down design approach inspired by proven Radio Control (RC) aircraft architectures, I defined the first high-level avionics and power system layout capable of stratospheric operation.
